...
const AGENT_MAPPING: Record<string, string[]> = {
  planner: ['baseline/requirements.json', 'baseline/input-requirements.md', 'baseline/original-requirements.md'],
  ...
  const filteredArtifacts = useMemo(() => {
    ...
    if (selectedNode === 'planner') {
      const baselineFiles = Object.keys(artifacts)
        ...
        .sort((left, right) => {
          const preferred = ['baseline/requirement-item.json', 'baseline/requirements.json', 'baseline/input-requirements.md', 'baseline/original-requirements.md'];
        ...
        <aside className="col-span-12 lg:col-span-3 space-y-8">
          <section className="bg-white rounded-3xl border border-gray-100 shadow-sm p-6 space-y-6">
            ...
            <div className="grid grid-cols-1 gap-2">
              ...
              {renderUploadBtn('logical', t('projectDetail.uploadLogical'), <FolderGit2 size={14} />)}
              {renderUploadBtn('dict', t('projectDetail.uploadDict'), <BookOpen size={14} />)}
              {renderUploadBtn('lookup', t('projectDetail.uploadLookup'), <BarChart3 size={14} />)}
            </div>

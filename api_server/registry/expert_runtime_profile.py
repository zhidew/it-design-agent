...
GENERIC_BOUNDARY_NOTE = "Keep each artifact concise and limited to this expert's primary responsibility."

LEGACY_CAPABILITY_SCOPE_NOTES = {
...
LEGACY_SHARED_CONTEXT_OWNER_CAPABILITIES = {"modular-design", "architecture-mapping", "design-assembler"}
...
LEGACY_CAPABILITY_KEYWORDS = {
    "architecture-mapping": ["模块化", "模块", "边界", "交互", "容器", "上下文", "复用点"],
}

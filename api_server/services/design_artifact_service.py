...
def infer_expert_id_for_file(file_name: str) -> str:
    ...
    if lower.startswith("schema") or lower in {"er.md", "migration-plan.md"}:
        return "data-design"
    if lower.startswith("api") or lower.startswith("errors-"):
        return "api-design"
    if lower.startswith("sequence-") or lower.startswith("state-"):
        return "flow-design"
    if lower.startswith("class-") or lower.startswith("ddd-"):
        return "ddd-structure"
    if lower.startswith("test-"):
        return "test-design"
    if lower.startswith("slo") or lower.startswith("observability") or lower.startswith("deployment"):
        return "ops-design"
    if lower.startswith("detailed") or lower.startswith("traceability") or lower.startswith("review-checklist"):
        return "design-assembler"
    if lower.startswith("validator") or lower.startswith("validation"):
        return "validator"
    if lower.startswith("config"):
        return "config-design"
    if lower.startswith("integration") or lower.startswith("asyncapi"):
        return "integration-design"
    if lower.startswith("module") or lower.startswith("architecture"):
